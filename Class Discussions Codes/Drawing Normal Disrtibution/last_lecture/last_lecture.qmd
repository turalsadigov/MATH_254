...
-   Statistics: cases, variables, dataframes, numerical and graphical
    summaries, Sampling distributions, Central Limit Theorem

-   Hypothesis testing, Common statistical tests (z, t), p-values,
    dicing and slicing, Multiple Testing, Permutation tests, $\chi^2$
    tests

-   Classical Confidence Intervals, Bootstrap Percentile Confidence
    Intervals
...
-   Linear, multiple, polynomial regression, Model assessments,
    Diagnostics
...
-   `modelStudio, DALEX, vip`

## Tidymodels

![](tidymodels.png){fig-align="center"}
...
df = pd.read_csv('https://raw.githubusercontent.com/turalsadigov/MATH_254/main/data/county.csv')
df = df.dropna()
...
library(tidymodels)
library(tidyverse)
df <- read_csv('https://raw.githubusercontent.com/turalsadigov/MATH_254/main/data/county.csv')
df <- df %>% 
  drop_na() %>% 
...
![](officially_dad_jokes_thank_you_card-r01282b2ac4ff41059cc0fda9d8e4210d_tcvt0_736.webp){fig-align="center"
width="475"}
